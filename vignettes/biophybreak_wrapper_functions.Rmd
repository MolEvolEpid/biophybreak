...
the \code{phybreak}, \code{burnin_phybreak}, and \code{sample_phybreak} functions. 
...
The \code{phybreak.plot.triple} function is a good way to get an overview of the inference results for each cluster.
...
Since \code{run.biophybreak} automatically computes and keeps track of effective sample sizes, 
